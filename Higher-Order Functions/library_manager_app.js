...
const getBookInformation = (catalog) => catalog.map(book => `${book.title} by ${book.author}`).join("\n")
console.log(getBookInformation(library ))

console.log("\nList of book summaries:\n");

const getBookSummaries = (books) => books.map((book) => book.about).join("\n")
console.log(getBookSummaries(library))

console.log("\nList of books by Arvid Kahl:\n");
const getBooksByAuthor  = (books, author) =>books.filter((book)=>(book.author == author))
